          ...
          <div className="flex flex-col sm:flex-row sm:justify-between gap-8">
            ...
            <div>
              ...
              <div className="space-y-1">
                {profile?.email && (
                  <a href={`mailto:${profile.email}`} className="flex items-center gap-1 text-gray-400 hover:text-emerald-400 text-sm transition-colors">
                ...
                {profile?.no_hp && (
                  <a href={`tel:${profile.no_hp}`} className="flex items-center gap-1 text-gray-400 hover:text-emerald-400 text-sm transition-colors">
