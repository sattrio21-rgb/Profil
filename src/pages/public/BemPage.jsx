            ...
            <div className="space-y-4">
              {pengalamans.map((item, index) => (
                <ScrollAnimate key={item.id} delay={index * 100}>
                  <div className="group p-6 bg-white/[0.02] border border-white/5 rounded-2xl hover:bg-white/[0.04] hover:border-blue-500/20 transition-all duration-300">
                    <div className="flex flex-col sm:flex-row sm:items-start gap-5">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-blue-400 font-medium mb-3">{item.jabatan}</p>
                        {item.deskripsi && (
